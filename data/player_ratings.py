...
_POSITION_WEIGHTS: Dict[str, List[tuple]] = {
    ...
    "MF": [("xa_share", 0.25), ("build_share", 0.15), ("def_share", 0.15),
           ("xg_share", 0.15), ("goals_share", 0.10), ("key_passes_share", 0.10),
           ("progressive_share", 0.10)],
    "DF": [("def_share", 0.35), ("def_volume_share", 0.15), ("blocks_share", 0.10),
           ("clearances_share", 0.10), ("xg_share", 0.10), ("xa_share", 0.10),
           ("cs_share", 0.05), ("goals_share", 0.05)],
...
def _build_shares(rec: PlayerRecord, tt: TeamTotals,
    ...
    return {
        ...
        "blocks_share": s(rec.blocks, tt.shots_against),
        "clearances_share": s(rec.clearances, tt.shots_against + tt.corners_against),
        "key_passes_share": s(rec.key_passes, tt.shots),
        "progressive_share": s(rec.progressive_passes, tt.corners + tt.shots),
